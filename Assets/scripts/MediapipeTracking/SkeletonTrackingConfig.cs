...
namespace Mediapipe.Unity.SkeletonTracking.UI {
    public class SkeletonTrackingConfig : ModalContents {
        ...
        private SkeletonTrackingSolution _solution;
        ...
        private void Start() {
            _solution = GameObject.Find("Solution").GetComponent<SkeletonTrackingSolution>();
            InitializeContents();
        }
        ...
        public void SwitchModelComplexity() {
            _solution.modelComplexity = (SkeletonTrackingGraph.ModelComplexity)_modelComplexityInput.value;
            _isChanged = true;
        }
        ...
        private void InitializeModelComplexity() {
            ...
            var options = new List<string>(Enum.GetNames(typeof(SkeletonTrackingGraph.ModelComplexity)));
