...
{
  public class SelfieSegmentationSolution : Solution
  {
    [SerializeField] private Screen _screen;
    [SerializeField] private MaskAnnotationController _selfieMaskAnnotationController;
    [SerializeField] private SelfieSegmentationGraph _graphRunner;
    ...
    private IEnumerator Run()
    {
      ...
      {
        _graphRunner.OnSelfieMaskOutput.AddListener(OnSelfieMaskOutput);
      ...
      SetupAnnotationController(_selfieMaskAnnotationController, imageSource);
      ...
      while (true)
      {
        ...
        if (runningMode == RunningMode.Sync)
        {
          ...
          var selfieMask = _graphRunner.FetchNextValue();
          _selfieMaskAnnotationController.DrawNow(selfieMask);
        }
    ...
    private void OnSelfieMaskOutput(ImageFrame selfieMask)
    {
      _selfieMaskAnnotationController.DrawLater(selfieMask);
    }
